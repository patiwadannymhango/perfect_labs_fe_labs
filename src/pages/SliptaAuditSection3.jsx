...
import SliptaAuditSection3Form  from "../components/SliptaAuditSection3Form";
...
function SliptaAuditSection3(){
    ...
    const handleRowClick = (params) => {
        navigate(`/slipta_audit_section_3_detail/${slipta_lab_profileId}/${params.row.id}/`);
    };
    const audits = useSWR(`/slipta/lab_profile/${slipta_lab_profileId}/audit_section_3/`,fetcher,{
    ...
    //             <SliptaAuditSection3Form refresh={audits.mutate} lab_profile_id={slipta_lab_profileId} />
    //             <br />
    //             <DataGrid
    //                 rows={data}
    //                 columns={columns}
...
export default SliptaAuditSection3;