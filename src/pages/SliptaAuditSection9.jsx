...
import SliptaAuditSection9Form  from "../components/SliptaAuditSection9Form";
...
function SliptaAuditSection9(){
    ...
    const handleRowClick = (params) => {
        navigate(`/slipta_audit_section_9_detail/${slipta_lab_profileId}/${params.row.id}/`);
    };
    const audits = useSWR(`/slipta/lab_profile/${slipta_lab_profileId}/audit_section_9/`,fetcher,{
    ...
    //             <SliptaAuditSection9Form refresh={audits.mutate} lab_profile_id={slipta_lab_profileId} />
    //             <br />
    //             <DataGrid
    //                 rows={data}
    //                 columns={columns}
...
export default SliptaAuditSection9;