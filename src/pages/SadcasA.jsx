...
export default function SadcasA(){
    ...
    const handleRowClick = (params) => {       
        ...
        navigate(`/sadcas_a_summary/${params.row.id}/`);
    ...
    const columns = [
        ...
        { field: 'lab_physical_address', headerName: 'Physical Address', width: 250 },
        ...
        { field: 'lab_incharge_name', headerName: 'Name of Facility Incharge', width: 250 },
        { field: 'lab_incharge_qualification', headerName: 'Qualification', width: 250 },
        { field: 'lab_incharge_phone', headerName: 'Personal Telephone', width: 250 },
               ...
               <Box sx={{ mb: 2, textAlign: 'left' }}>
                ...
                <Paper>
                        <Card sx={{ maxWidth: '100%', mb: 2 }}>
                            <CardHeader
                            title="SADCAS - F134 A : LABORATORY LIST"
                            sx={{
                                backgroundColor: '#ddd',
