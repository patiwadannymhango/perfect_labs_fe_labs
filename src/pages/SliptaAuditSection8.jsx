...
import SliptaAuditSection8Form  from "../components/SliptaAuditSection8Form";
...
function SliptaAuditSection8(){
    ...
    const handleRowClick = (params) => {
        navigate(`/slipta_audit_section_8_detail/${slipta_lab_profileId}/${params.row.id}/`);
    };
    const audits = useSWR(`/slipta/lab_profile/${slipta_lab_profileId}/audit_section_8/`,fetcher,{
    ...
    //             <SliptaAuditSection8Form refresh={audits.mutate} lab_profile_id={slipta_lab_profileId} />
    //             <br />
    //             <DataGrid
    //                 rows={data}
    //                 columns={columns}
...
export default SliptaAuditSection8;