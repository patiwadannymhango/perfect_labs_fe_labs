...
export function SliptaAuditSection12Detail(){
    ...
    const { data, error } = useSWR(`/slipta/lab_profile/${slipta_lab_profileId}/audit_section_12/${qID}/`, fetcher, {
      ...
      const handleDelete = () => {
        axiosService
        .delete(`/slipta/lab_profile/${slipta_lab_profileId}/audit_section_12/${qID}/`)
        .then(() => {
            navigate(`/slipta_audit_section_12/${slipta_lab_profileId}/`);
        })
        .catch((err) => {
            if (err.message) {
    ...
    const onSubmit = form => {
        ...
        axiosService
        .put(`/slipta/lab_profile/${slipta_lab_profileId}/audit_section_12/${qID}/`,form)
        .then(() => {
          setSnackbarOpen(true);
