...
import SliptaAuditSection10Form  from "../components/SliptaAuditSection10Form";
...
function SliptaAuditSection10(){
    ...
    const handleRowClick = (params) => {
        navigate(`/slipta_audit_section_10_detail/${slipta_lab_profileId}/${params.row.id}/`);
    };
    const audits = useSWR(`/slipta/lab_profile/${slipta_lab_profileId}/audit_section_10/`,fetcher,{
    ...
    //             <SliptaAuditSection10Form refresh={audits.mutate} lab_profile_id={slipta_lab_profileId} />
    //             <br />
    //             <DataGrid
    //                 rows={data}
    //                 columns={columns}
...
export default SliptaAuditSection10;