...
import SliptaAuditSection11Form  from "../components/SliptaAuditSection11Form";
...
function SliptaAuditSection11(){
    ...
    const handleRowClick = (params) => {
        navigate(`/slipta_audit_section_11_detail/${slipta_lab_profileId}/${params.row.id}/`);
    };
    const audits = useSWR(`/slipta/lab_profile/${slipta_lab_profileId}/audit_section_11/`,fetcher,{
    ...
    //             <SliptaAuditSection11Form refresh={audits.mutate} lab_profile_id={slipta_lab_profileId} />
    //             <br />
    //             <DataGrid
    //                 rows={data}
    //                 columns={columns}
...
export default SliptaAuditSection11;