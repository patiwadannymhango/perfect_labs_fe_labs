...
export function LabTestsPathology() {
  const {
    control,
    register,
    handleSubmit,
    ...
    defaultValues: {
      pathology_available: "",
      pathology_connected_disa: "",
      pathology_available_comment: "",
      pathology_connected_disa_comment: "",
      pathology_test_performed: "",
      pathology_test_referred: "",
      pathology_equipment_in_use: "",
      are_pathology_equip_fun_serv: "",
      pathology_unfun_eq_eng: "",
      pathology_unserv_eq_staff: "",
      pathology_unfun_eq_chal: "",
      pathology_unserv_eq_chal: "",
      pathology_power_adequate: "",
      pathology_refrigerator_reagent: "",
      pathology_refrigerator_sample: "",
      pathology_is_eqa_performed: "",
      pathology_eqa: "",
      pathology_comment: "",
    },
  });
          ...
          <Table style={tableStyle}>
            ...
            <TableBody>
              <TableRow>
                <TableCell>
                  {" "}
                  <h5>PATHOLOGY/HISTOPATHOLOGY SECTION</h5>{" "}
                </TableCell>
                <TableCell> </TableCell>
                <TableCell> </TableCell>
              </TableRow>
              ...
              <TableRow>
                ...
                <TableCell>
                  <TextField
                    ...
                    {...register("pathology_available_comment")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell>
                  <TextField
                    ...
                    fullWidth
                    label="Comment"
                    {...register("pathology_connected_disa_comment")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <TextField
                    ...
                    {...register("pathology_test_performed")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <TextField
                    ...
                    placeholder="Enter Tests"
                    {...register("pathology_test_referred")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <TextField
                    ...
                    {...register("pathology_equipment_in_use")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <MyRadioGroup
                    name="are_pathology_equip_fun_serv"
                    options={lab_adequate_options}
                    control={control}
                    rules={{ required: "Please select one option" }}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <TextField
                    ...
                    {...register("pathology_unfun_eq_eng")}
                    type="text"
                    multiline
                    rows={2}
                    sx={{ mb: 2 }}
                  ...
                  <TextField
                    ...
                    placeholder=" Enter Equipment "
                    {...register("pathology_unserv_eq_staff")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <TextField
                    ...
                    placeholder=" Enter Equipment "
                    {...register("pathology_unfun_eq_chal")}
                    type="text"
                    multiline
                    rows={2}
                    sx={{ mb: 2 }}
                  ...
                  <TextField
                    ...
                    placeholder=" Enter Equipment "
                    {...register("pathology_unserv_eq_chal")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <MyRadioGroup
                    name="pathology_refrigerator_reagent"
                    options={lab_adequate_options}
                    control={control}
                    rules={{ required: "Please select one option" }}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <MyRadioGroup
                    name="pathology_refrigerator_sample"
                    options={lab_adequate_options}
                    control={control}
                    rules={{ required: "Please select one option" }}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <MyRadioGroup
                    name="pathology_is_eqa_performed"
                    options={lab_adequate_options}
                    control={control}
                    rules={{ required: "Please select one option" }}
                  />
