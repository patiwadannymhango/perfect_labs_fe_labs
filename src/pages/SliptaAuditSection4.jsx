...
import SliptaAuditSection4Form  from "../components/SliptaAuditSection4Form";
...
function SliptaAuditSection4(){
    ...
    const handleRowClick = (params) => {
        navigate(`/slipta_audit_section_4_detail/${slipta_lab_profileId}/${params.row.id}/`);
    };
    const audits = useSWR(`/slipta/lab_profile/${slipta_lab_profileId}/audit_section_4/`,fetcher,{
    ...
    //             <SliptaAuditSection4Form refresh={audits.mutate} lab_profile_id={slipta_lab_profileId} />
    //             <br />
    //             <DataGrid
    //                 rows={data}
    //                 columns={columns}
...
export default SliptaAuditSection4;