...
import SliptaAuditSection12Form  from "../components/SliptaAuditSection12Form";
...
function SliptaAuditSection12(){
    ...
    const handleRowClick = (params) => {
        navigate(`/slipta_audit_section_12_detail/${slipta_lab_profileId}/${params.row.id}/`);
    };
    const audits = useSWR(`/slipta/lab_profile/${slipta_lab_profileId}/audit_section_12/`,fetcher,{
    ...
    //             <SliptaAuditSection12Form refresh={audits.mutate} lab_profile_id={slipta_lab_profileId} />
    //             <br />
    //             <DataGrid
    //                 rows={data}
    //                 columns={columns}
...
export default SliptaAuditSection12;