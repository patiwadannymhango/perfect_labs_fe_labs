...
export function LabTestsParasitology() {
  const {
    control,
    register,
    handleSubmit,
    ...
    defaultValues: {
      parasitology_available: "",
      parasitology_connected_disa: "",
      parasitology_available_comment: "",
      parasitology_connected_disa_comment: "",
      parasitology_test_performed: "",
      parasitology_test_referred: "",
      parasitology_equipment_in_use: "",
      are_parasitology_equip_fun_serv: "",
      parasitology_unfun_eq_eng: "",
      parasitology_unserv_eq_staff: "",
      parasitology_unfun_eq_chal: "",
      parasitology_unserv_eq_chal: "",
      parasitology_power_adequate: "",
      parasitology_refrigerator_reagent: "",
      parasitology_refrigerator_sample: "",
      parasitology_is_eqa_performed: "",
      parasitology_eqa: "",
      parasitology_comment: "",
    },
  });
          ...
          <Table style={tableStyle}>
            ...
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell>
                  <TextField
                    ...
                    {...register("parasitology_available_comment")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <MyRadioGroup
                    name="parasitology_connected_disa"
                    options={lab_adequate_options}
                    control={control}
                    rules={{ required: "Please select one option" }}
                  />
                ...
                <TableCell>
                  <TextField
                    ...
                    fullWidth
                    label="Comment"
                    {...register("parasitology_connected_disa_comment")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <TextField
                    ...
                    {...register("parasitology_test_performed")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <TextField
                    ...
                    placeholder="Enter Tests"
                    {...register("parasitology_test_referred")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <TextField
                    ...
                    {...register("parasitology_equipment_in_use")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <MyRadioGroup
                    name="are_parasitology_equip_fun_serv"
                    options={lab_adequate_options}
                    control={control}
                    rules={{ required: "Please select one option" }}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <TextField
                    ...
                    {...register("parasitology_unfun_eq_eng")}
                    type="text"
                    multiline
                    rows={2}
                    sx={{ mb: 2 }}
                  ...
                  <TextField
                    ...
                    placeholder=" Enter Equipment "
                    {...register("parasitology_unserv_eq_staff")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <TextField
                    ...
                    placeholder=" Enter Equipment "
                    {...register("parasitology_unfun_eq_chal")}
                    type="text"
                    multiline
                    rows={2}
                    sx={{ mb: 2 }}
                  ...
                  <TextField
                    ...
                    placeholder=" Enter Equipment "
                    {...register("parasitology_unserv_eq_chal")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <MyRadioGroup
                    name="parasitology_power_adequate"
                    options={lab_adequate_options}
                    control={control}
                    rules={{ required: "Please select one option" }}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <MyRadioGroup
                    name="parasitology_refrigerator_reagent"
                    options={lab_adequate_options}
                    control={control}
                    rules={{ required: "Please select one option" }}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <MyRadioGroup
                    name="parasitology_refrigerator_sample"
                    options={lab_adequate_options}
                    control={control}
                    rules={{ required: "Please select one option" }}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <MyRadioGroup
                    name="parasitology_is_eqa_performed"
                    options={lab_adequate_options}
                    control={control}
                    rules={{ required: "Please select one option" }}
                  />
