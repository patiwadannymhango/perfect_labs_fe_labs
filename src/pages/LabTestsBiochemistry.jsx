...
export function LabTestsBiochemistry(){

    const { control, register, handleSubmit, setValue, watch, formState: { errors } } = useForm({
        defaultValues: {
          biochemistry_available: '',
          biochemistry_connected_disa: '',
          biochemistry_available_comment: '',
          biochemistry_connected_disa_comment: '',
          biochemistry_test_performed: '',
          biochemistry_test_referred: '',
          biochemistry_equipment_in_use: '',
          are_biochemistry_equip_fun_serv: '',
          biochemistry_unfun_eq_eng: '',
          biochemistry_unserv_eq_staff: '',
          biochemistry_unfun_eq_chal: '',
          biochemistry_unserv_eq_chal: '',
          biochemistry_power_adequate: '',
          biochemistry_refrigerator_reagent: '',
          biochemistry_refrigerator_sample: '',
          biochemistry_is_eqa_performed: '',
          biochemistry_eqa: '',
          biochemistry_comment: '',
        }
      });
                                     ...
                                     <CardHeader
                                        ...
                                        <TableRow>
                                          ...
                                          <TableCell style={{ width: '60%' }}> </TableCell>
                                            ...
                                            <TableRow>
                                                <TableCell > <h5>BIOCHEMISTRY SECTION</h5> </TableCell>
                                                <TableCell> </TableCell>
                                                <TableCell> </TableCell>
                                            </TableRow>
                                            ...
                                            <TextField  InputProps={{ readOnly: true }}
                                              ...
                                              {...register('biochemistry_available_comment')}
                                              type="text" 
                                              multiline
                                                rows={2} 
                                            ...
                                            <TableRow>
                                                ...
                                                <TableCell align="left">
                                                <MyRadioGroup
                                                    name="biochemistry_connected_disa"
                                                    options={lab_adequate_options}
                                                    control={control}
                                                    rules={{ required: 'Please select one option' }}
                                                />
                                                ...
                                                <TextField  InputProps={{ readOnly: true }}
                                                  ...
                                                  fullWidth
                                                  label="Comment"
                                                  {...register('biochemistry_connected_disa_comment')}
                                                  type="text" 
                                                  multiline
                                                    rows={2} 
                                            ...
                                            <TableRow>
                                                ...
                                                <TextField  InputProps={{ readOnly: true }}
                                                        ...
                                                        {...register('biochemistry_test_performed')}
                                                        type="text"  
                                                        multiline
                                                        rows={2}
                                            ...
                                            <TableRow>
                                                ...
                                                <TextField  InputProps={{ readOnly: true }}
                                                        ...
                                                        placeholder="Enter Tests"
                                                        {...register('biochemistry_test_referred')}
                                                        type="text"  
                                                        multiline
                                                        rows={2}
                                            ...
                                            <TableRow>
                                                ...
                                                <TextField  InputProps={{ readOnly: true }}
                                                        ...
                                                        {...register('biochemistry_equipment_in_use')}
                                                        type="text"  
                                                        multiline
                                                        rows={2}
                                            ...
                                            <TableRow>
                                                ...
                                                <TableCell align="left">
                                                <MyRadioGroup
                                                    name="are_biochemistry_equip_fun_serv"
                                                    options={lab_adequate_options}
                                                    control={control}
                                                    rules={{ required: 'Please select one option' }}
                                                />
                                            ...
                                            <TableRow>
                                                ...
                                                <TextField  InputProps={{ readOnly: true }}
                                                        ...
                                                        {...register('biochemistry_unfun_eq_eng')}
                                                        type="text"  
                                                        multiline
                                                        rows={2}
                                                        sx={{ mb: 2 }}
                                                    ...
                                                    <TextField  InputProps={{ readOnly: true }}
                                                        ...
                                                        placeholder=" Enter Equipment "
                                                        {...register('biochemistry_unserv_eq_staff')}
                                                        type="text"  
                                                        multiline
                                                        rows={2}
                                            ...
                                            <TableRow>
                                                ...
                                                <TextField  InputProps={{ readOnly: true }}
                                                        ...
                                                        placeholder=" Enter Equipment "
                                                        {...register('biochemistry_unfun_eq_chal')}
                                                        type="text"  
                                                        multiline
                                                        rows={2}
                                                        sx={{ mb: 2 }}
                                                    ...
                                                    <TextField  InputProps={{ readOnly: true }}
                                                        ...
                                                        placeholder=" Enter Equipment "
                                                        {...register('biochemistry_unserv_eq_chal')}
                                                        type="text"  
                                                        multiline
                                                        rows={2}
                                            ...
                                            <TableRow>
                                                ...
                                                <TableCell align="left">
                                                <MyRadioGroup
                                                    name="biochemistry_power_adequate"
                                                    options={lab_adequate_options}
                                                    control={control}
                                                    rules={{ required: 'Please select one option' }}
                                                />
                                            ...
                                            <TableRow>
                                                ...
                                                <TableCell align="left">
                                                <MyRadioGroup
                                                    name="biochemistry_refrigerator_reagent"
                                                    options={lab_adequate_options}
                                                    control={control}
                                                    rules={{ required: 'Please select one option' }}
                                                />
                                            ...
                                            <TableRow>
                                                ...
                                                <TableCell align="left">
                                                <MyRadioGroup
                                                    name="biochemistry_refrigerator_sample"
                                                    options={lab_adequate_options}
                                                    control={control}
                                                    rules={{ required: 'Please select one option' }}
                                                />
                                            ...
                                            <TableRow>
                                                ...
                                                <TableCell align="left">
                                                <MyRadioGroup
                                                    name="biochemistry_is_eqa_performed"
                                                    options={lab_adequate_options}
                                                    control={control}
                                                    rules={{ required: 'Please select one option' }}
                                                />
