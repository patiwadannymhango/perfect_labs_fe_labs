...
import { SliptaAuditSection2Form } from "../components/SliptaAuditSection2Form";
...
function SliptaAuditSection2(){
    ...
    const handleRowClick = (params) => {
        navigate(`/slipta_audit_section_2_detail/${slipta_lab_profileId}/${params.row.id}/`);
    };
  
    const audits = useSWR(`/slipta/lab_profile/${slipta_lab_profileId}/audit_section_2/`,fetcher,{
    ...
    //             <SliptaAuditSection2Form refresh={audits.mutate} lab_profile_id={slipta_lab_profileId} />
    //             <br />
    //             <DataGrid
    //                 rows={data}
    //                 columns={columns}
...
export default SliptaAuditSection2;