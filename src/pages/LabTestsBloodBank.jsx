...
export function LabTestsBloodBank(){

    const { control, register, handleSubmit, setValue, watch, formState: { errors } } = useForm({
        defaultValues: {
          bloodbank_available: '',
          bloodbank_connected_disa: '',
          bloodbank_available_comment: '',
          bloodbank_connected_disa_comment: '',
          bloodbank_test_performed: '',
          bloodbank_test_referred: '',
          bloodbank_equipment_in_use: '',
          are_bloodbank_equip_fun_serv: '',
          bloodbank_unfun_eq_eng: '',
          bloodbank_unserv_eq_staff: '',
          bloodbank_unfun_eq_chal: '',
          bloodbank_unserv_eq_chal: '',
          bloodbank_power_adequate: '',
          bloodbank_refrigerator_reagent: '',
          bloodbank_refrigerator_sample: '',
          bloodbank_is_eqa_performed: '',
          bloodbank_eqa: '',
          bloodbank_comment: '',
        }
      });
                        ...
                        <Card sx={{ maxWidth: '100%', mb: 2 }}>
                                     ...
                                     <CardHeader
                                        ...
                                        <TableCell style={{ width: '60%' }}> </TableCell>
                                            ...
                                            <TableRow>
                                                <TableCell > <h5>BLOOD BANK SECTION</h5> </TableCell>
                                                <TableCell> </TableCell>
                                                <TableCell> </TableCell>
                                            </TableRow>
                                            ...
                                            <TextField  InputProps={{ readOnly: true }}
                                              ...
                                              {...register('bloodbank_available_comment')}
                                              type="text" 
                                              multiline
                                                rows={2} 
                                            ...
                                            <TableRow>
                                                ...
                                                <TextField  InputProps={{ readOnly: true }}
                                                  ...
                                                  fullWidth
                                                  label="Comment"
                                                  {...register('bloodbank_connected_disa_comment')}
                                                  type="text" 
                                                  multiline
                                                    rows={2} 
                                            ...
                                            <TableRow>
                                                ...
                                                <TextField  InputProps={{ readOnly: true }}
                                                        ...
                                                        {...register('bloodbank_test_performed')}
                                                        type="text"  
                                                        multiline
                                                        rows={2}
                                            ...
                                            <TableRow>
                                                ...
                                                <TextField  InputProps={{ readOnly: true }}
                                                        ...
                                                        placeholder="Enter Tests"
                                                        {...register('bloodbank_test_referred')}
                                                        type="text"  
                                                        multiline
                                                        rows={2}
                                            ...
                                            <TableRow>
                                                ...
                                                <TextField  InputProps={{ readOnly: true }}
                                                        ...
                                                        {...register('bloodbank_equipment_in_use')}
                                                        type="text"  
                                                        multiline
                                                        rows={2}
                                            ...
                                            <TableRow>
                                                ...
                                                <TableCell align="left">
                                                <MyRadioGroup
                                                    name="are_bloodbank_equip_fun_serv"
                                                    options={lab_adequate_options}
                                                    control={control}
                                                    rules={{ required: 'Please select one option' }}
                                                />
                                            ...
                                            <TableRow>
                                                ...
                                                <TextField  InputProps={{ readOnly: true }}
                                                        ...
                                                        {...register('bloodbank_unfun_eq_eng')}
                                                        type="text"  
                                                        multiline
                                                        rows={2}
                                                        sx={{ mb: 2 }}
                                                    ...
                                                    <TextField  InputProps={{ readOnly: true }}
                                                        ...
                                                        placeholder=" Enter Equipment "
                                                        {...register('bloodbank_unserv_eq_staff')}
                                                        type="text"  
                                                        multiline
                                                        rows={2}
                                            ...
                                            <TableRow>
                                                ...
                                                <TextField  InputProps={{ readOnly: true }}
                                                        ...
                                                        placeholder=" Enter Equipment "
                                                        {...register('bloodbank_unfun_eq_chal')}
                                                        type="text"  
                                                        multiline
                                                        rows={2}
                                                        sx={{ mb: 2 }}
                                                    ...
                                                    <TextField  InputProps={{ readOnly: true }}
                                                        ...
                                                        placeholder=" Enter Equipment "
                                                        {...register('bloodbank_unserv_eq_chal')}
                                                        type="text"  
                                                        multiline
                                                        rows={2}
                                            ...
                                            <TableRow>
                                                ...
                                                <TableCell align="left">
                                                <MyRadioGroup
                                                    name="bloodbank_refrigerator_reagent"
                                                    options={lab_adequate_options}
                                                    control={control}
                                                    rules={{ required: 'Please select one option' }}
                                                />
                                            ...
                                            <TableRow>
                                                ...
                                                <TableCell align="left">
                                                <MyRadioGroup
                                                    name="bloodbank_refrigerator_sample"
                                                    options={lab_adequate_options}
                                                    control={control}
                                                    rules={{ required: 'Please select one option' }}
                                                />
                                            ...
                                            <TableRow>
                                                ...
                                                <TableCell align="left">
                                                <MyRadioGroup
                                                    name="bloodbank_is_eqa_performed"
                                                    options={lab_adequate_options}
                                                    control={control}
                                                    rules={{ required: 'Please select one option' }}
                                                />
