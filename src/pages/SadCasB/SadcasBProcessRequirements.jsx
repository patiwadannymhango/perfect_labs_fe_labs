...
const SadcasBProcessRequirements = () => {
	const {
		control,
		register,
		handleSubmit,
		...
		defaultValues: {
			sadcas_b_process_requirements_a:"",
			sadcas_b_process_requirements_comment:"",
		},
	})
...
export default SadcasBProcessRequirements

const items = [
	{
		letter: 'a)',
		label:
			'Does the laboratory identify potential risks to patient care in the pre-examination, examination and post-examination processes?',
		name: 'sadcas_b_process_requirements_a',
		clauseNo: '7.1',
	},
	{
		letter: 'b)',
		label:
			'Are the identified risks and effectiveness of the mitigation processes monitored and evaluated according to the potential harm to the patient? ',
		name: 'sadcas_b_process_requirements_b',
		clauseNo: '',
	},
]
