				...
				<form
					...
					<CardHeader
						title={
							labName.toUpperCase() +
								' : ' +
								'CLAUSE 6.3 - FACILITIES AND ENVIRONMENT ' || ''
						}
						sx={{
...
export default SadcasBFacEnvs

const items = [
	{
		letter: 'a)',
		label:
			'Were the requirements for facilities and environmental conditions necessary for the performance of the laboratory activities specified, monitored and recorded?',
		name: 'fac_envs_a',
		clauseNo: '6.3.1',
	},
	{
		letter: 'b)',
		label:
			'What measures are put in place to prevent cross-contamination, where examination procedures pose a risk, or where work can be affected or influenced by lack of separation?',
		name: 'fac_envs_b',
		clauseNo: '6.3.2(c) ',
	},
	{
		letter: 'c)',
		label:
			'Were patient samples and materials used in the examination processes stored in a manner that prevents cross contamination and deterioration? ',
		name: 'fac_envs_c',
		clauseNo: '6.3.3(b)',
	},
	{
		letter: 'd)',
		label:
			'Were storage and disposal facilities for hazardous materials and biological waste appropriate to the classification of the materials in the context of any statutory or regularory requirements?',
		name: 'fac_envs_d',
		clauseNo: '6.3.3(c)',
	},
]
