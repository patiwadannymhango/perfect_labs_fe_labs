...
export function LabTestsSpecialTest() {
  const {
    control,
    register,
    handleSubmit,
    ...
    defaultValues: {
      specialtest_available: "",
      specialtest_connected_disa: "",
      specialtest_available_comment: "",
      specialtest_connected_disa_comment: "",
      specialtest_test_performed: "",
      specialtest_test_referred: "",
      specialtest_equipment_in_use: "",
      are_specialtest_equip_fun_serv: "",
      specialtest_unfun_eq_eng: "",
      specialtest_unserv_eq_staff: "",
      specialtest_unfun_eq_chal: "",
      specialtest_unserv_eq_chal: "",
      specialtest_power_adequate: "",
      specialtest_refrigerator_reagent: "",
      specialtest_refrigerator_sample: "",
      specialtest_is_eqa_performed: "",
      specialtest_eqa: "",
      specialtest_comment: "",
    },
  });
          ...
          <Table style={tableStyle}>
            ...
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell>
                  <TextField
                    ...
                    {...register("specialtest_available_comment")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <MyRadioGroup
                    name="specialtest_connected_disa"
                    options={lab_adequate_options}
                    control={control}
                    rules={{ required: "Please select one option" }}
                  />
                ...
                <TableCell>
                  <TextField
                    ...
                    fullWidth
                    label="Comment"
                    {...register("specialtest_connected_disa_comment")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <TextField
                    ...
                    {...register("specialtest_test_performed")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <TextField
                    ...
                    placeholder="Enter Tests"
                    {...register("specialtest_test_referred")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <TextField
                    ...
                    {...register("specialtest_equipment_in_use")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <MyRadioGroup
                    name="are_specialtest_equip_fun_serv"
                    options={lab_adequate_options}
                    control={control}
                    rules={{ required: "Please select one option" }}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <TextField
                    ...
                    {...register("specialtest_unfun_eq_eng")}
                    type="text"
                    multiline
                    rows={2}
                    sx={{ mb: 2 }}
                  ...
                  <TextField
                    ...
                    placeholder=" Enter Equipment "
                    {...register("specialtest_unserv_eq_staff")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <TextField
                    ...
                    placeholder=" Enter Equipment "
                    {...register("specialtest_unfun_eq_chal")}
                    type="text"
                    multiline
                    rows={2}
                    sx={{ mb: 2 }}
                  ...
                  <TextField
                    ...
                    placeholder=" Enter Equipment "
                    {...register("specialtest_unserv_eq_chal")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <MyRadioGroup
                    name="specialtest_power_adequate"
                    options={lab_adequate_options}
                    control={control}
                    rules={{ required: "Please select one option" }}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <MyRadioGroup
                    name="specialtest_refrigerator_reagent"
                    options={lab_adequate_options}
                    control={control}
                    rules={{ required: "Please select one option" }}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <MyRadioGroup
                    name="specialtest_refrigerator_sample"
                    options={lab_adequate_options}
                    control={control}
                    rules={{ required: "Please select one option" }}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <MyRadioGroup
                    name="specialtest_is_eqa_performed"
                    options={lab_adequate_options}
                    control={control}
                    rules={{ required: "Please select one option" }}
                  />
