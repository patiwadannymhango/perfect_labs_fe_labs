...
export function LabTestsImmunology() {
  const {
    control,
    register,
    handleSubmit,
    ...
    defaultValues: {
      immunology_available: "",
      immunology_connected_disa: "",
      immunology_available_comment: "",
      immunology_connected_disa_comment: "",
      immunology_test_performed: "",
      immunology_test_referred: "",
      immunology_equipment_in_use: "",
      are_immunology_equip_fun_serv: "",
      immunology_unfun_eq_eng: "",
      immunology_unserv_eq_staff: "",
      immunology_unfun_eq_chal: "",
      immunology_unserv_eq_chal: "",
      immunology_power_adequate: "",
      immunology_refrigerator_reagent: "",
      immunology_refrigerator_sample: "",
      immunology_is_eqa_performed: "",
      immunology_eqa: "",
      immunology_comment: "",
    },
  });
          ...
          <Table style={tableStyle}>
            ...
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell>
                  <TextField
                    ...
                    {...register("immunology_available_comment")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <MyRadioGroup
                    name="immunology_connected_disa"
                    options={lab_adequate_options}
                    control={control}
                    rules={{ required: "Please select one option" }}
                  />
                ...
                <TableCell>
                  <TextField
                    ...
                    fullWidth
                    label="Comment"
                    {...register("immunology_connected_disa_comment")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <TextField
                    ...
                    {...register("immunology_test_performed")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <TextField
                    ...
                    placeholder="Enter Tests"
                    {...register("immunology_test_referred")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <TextField
                    ...
                    {...register("immunology_equipment_in_use")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <MyRadioGroup
                    name="are_immunology_equip_fun_serv"
                    options={lab_adequate_options}
                    control={control}
                    rules={{ required: "Please select one option" }}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <TextField
                    ...
                    {...register("immunology_unfun_eq_eng")}
                    type="text"
                    multiline
                    rows={2}
                    sx={{ mb: 2 }}
                  ...
                  <TextField
                    ...
                    placeholder=" Enter Equipment "
                    {...register("immunology_unserv_eq_staff")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <TextField
                    ...
                    placeholder=" Enter Equipment "
                    {...register("immunology_unfun_eq_chal")}
                    type="text"
                    multiline
                    rows={2}
                    sx={{ mb: 2 }}
                  ...
                  <TextField
                    ...
                    placeholder=" Enter Equipment "
                    {...register("immunology_unserv_eq_chal")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <MyRadioGroup
                    name="immunology_power_adequate"
                    options={lab_adequate_options}
                    control={control}
                    rules={{ required: "Please select one option" }}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <MyRadioGroup
                    name="immunology_refrigerator_reagent"
                    options={lab_adequate_options}
                    control={control}
                    rules={{ required: "Please select one option" }}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <MyRadioGroup
                    name="immunology_refrigerator_sample"
                    options={lab_adequate_options}
                    control={control}
                    rules={{ required: "Please select one option" }}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <MyRadioGroup
                    name="immunology_is_eqa_performed"
                    options={lab_adequate_options}
                    control={control}
                    rules={{ required: "Please select one option" }}
                  />
