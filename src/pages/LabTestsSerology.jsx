...
export function LabTestsSerology() {
  const {
    control,
    register,
    handleSubmit,
    ...
    defaultValues: {
      section_1_score: "",
      serology_available: "",
      serology_available_comment: "",
      serology_connected_disa: "",
      serology_connected_disa_comment: "",
      serology_test_performed: "",
      serology_test_referred: "",
      serology_equipment_in_use: "",
      are_serology_equip_fun_serv: "",
      serology_unfun_eq_eng: "",
      serology_unserv_eq_staff: "",
      serology_unfun_eq_chal: "",
      serology_unserv_eq_chal: "",
      serology_power_adequate: "",
      serology_refrigerator_reagent: "",
      serology_refrigerator_sample: "",
      serology_is_eqa_performed: "",
      serology_eqa: "",
      serology_comment: "",
    },
  });
          ...
          <Table style={tableStyle}>
            ...
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell>
                  <TextField
                    ...
                    {...register("serology_available_comment")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell>
                  <TextField
                    ...
                    fullWidth
                    label="Comment"
                    {...register("serology_connected_disa_comment")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <TextField
                    ...
                    {...register("serology_test_performed")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <TextField
                    ...
                    placeholder="Enter Tests"
                    {...register("serology_test_referred")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <TextField
                    ...
                    {...register("serology_equipment_in_use")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <MyRadioGroup
                    name="are_serology_equip_fun_serv"
                    options={lab_adequate_options}
                    control={control}
                    rules={{ required: "Please select one option" }}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <TextField
                    ...
                    {...register("serology_unfun_eq_eng")}
                    type="text"
                    multiline
                    rows={2}
                    sx={{ mb: 2 }}
                  ...
                  <TextField
                    ...
                    placeholder=" Enter Equipment "
                    {...register("serology_unserv_eq_staff")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <TextField
                    ...
                    placeholder=" Enter Equipment "
                    {...register("serology_unfun_eq_chal")}
                    type="text"
                    multiline
                    rows={2}
                    sx={{ mb: 2 }}
                  ...
                  <TextField
                    ...
                    placeholder=" Enter Equipment "
                    {...register("serology_unserv_eq_chal")}
                    type="text"
                    multiline
                    rows={2}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <MyRadioGroup
                    name="serology_refrigerator_reagent"
                    options={lab_adequate_options}
                    control={control}
                    rules={{ required: "Please select one option" }}
                  />
              ...
              <TableRow>
                ...
                <TableCell align="left">
                  <MyRadioGroup
                    name="serology_refrigerator_sample"
                    options={lab_adequate_options}
                    control={control}
                    rules={{ required: "Please select one option" }}
                  />
