...
const SliptaAuditSection5Form = ( props ) => {
    ...
    const onSubmit = form => {
        ...
        axiosService
        .post(`/slipta/lab_profile/${lab_profile_id}/audit_section_5/`,form)
        .then(() => {
        onDialogClose();
        setSnackbarOpen(true);
        setSnackbarMessage(`Section 5: Equipment Management`);
        refresh();
    ...
    return (
        <>
            ...
            <CardHeader
                        title="SECTION 05: EQUIPMENT MANAGEMENT"
                        sx={{
...
export default SliptaAuditSection5Form;